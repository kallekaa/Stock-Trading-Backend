"""Generate time-series forecasts using the finalized weekly model."""
...
PREDICTION_DIR = Path("data/predictions/weekly/time_series")
DROP_COLUMNS = ["date", "ticker"]


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run weekly time-series inference")
...
def main() -> None:
    ...
    print(f"Saved weekly time-series predictions (h={horizon}) -> {output_path}")
