"""Generate regression predictions using the finalized daily model."""
...
PREDICTION_DIR = Path("data/predictions/daily/regression")
DROP_COLUMNS = ["date", "ticker"]


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run daily regression inference")
...
def main() -> None:
    ...
    print(f"Saved regression predictions -> {output_path}")
