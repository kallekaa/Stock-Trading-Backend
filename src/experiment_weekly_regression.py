"""Run baseline regression experiments on weekly processed data."""
...
RESULTS_ROOT = Path("data/results/experiments/weekly/regression")
DROP_COLUMNS = ["date", "ticker"]


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run baseline regression models on weekly features")
...
def run_experiment(args: argparse.Namespace, config: dict) -> None:
    ...
    for spec in models:
        ...
        print(f"Completed weekly regression experiment -> {run_dir}")
