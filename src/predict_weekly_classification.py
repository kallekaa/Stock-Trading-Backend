"""Generate classification predictions using the finalized weekly model."""
...
PREDICTION_DIR = Path("data/predictions/weekly/classification")
DROP_COLUMNS = ["date", "ticker"]


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run weekly classification inference")
...
def main() -> None:
    ...
    print(f"Saved weekly classification predictions -> {output_path}")
